...
(function(scope, root, $) {
	...
	function RendezVousNode(_$node, _settings, _callback) {
		...
		var defaultTemplates = {
			...
			input: {
				default:
					'<input class="%prefix-input-date"  type="text"%readonly  id="rendez-date" name="rendez-date"   onclick="destory(this)" data-container="body"  data-placement="right"  title="<sp class=fg-red>日期输入有误 </sp>" data-content=""    data-html="true" maxlength="8"  >',
				split:
